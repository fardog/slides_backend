...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Presentation.last_modified'
        db.add_column(u'presentation_presentation', 'last_modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2014, 2, 4, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Presentation.last_modified'
        db.delete_column(u'presentation_presentation', 'last_modified')
